						...
						<div className="luxpure2">
							<div className="row">
								<div className="col-10 col-md-9 col-lg-10 col-xl-9">
									<p className="luxpure4"><span>Nazimabad #3 Billboard</span></p>
	  								<p className="luxpure3"><span>Status: Available</span></p>
  								</div>
...
/*<div className="row">
			      	...
			      	<div className="row">
			      		<div className="col-md-4 pencil1">
			      			<div className="key1">
			      				<img src="./images/bill4.png" className="imgsize"/>
			      			</div>
			      			<div className="key2">
			      				<div style={{color: 'white'}}>
					      			<p className="key3"> This is the faltu text<span className="fa fa-heart key5"></span><span style={{color:"black"}}></span></p>
			      		...
			      		<div className="col-md-4 text-center">
			      			<div className="key1">
			      				<img src="./images/bill5.png" className="imgsize"/>
			      			</div>	
			      			<div className="key6">
			      				<div style={{color: 'white'}}>
					      			<p className="key3"> This is the faltu text<span className="fa fa-heart key5"></span><span style={{color:"black"}}></span></p>
