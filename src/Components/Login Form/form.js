    ...
    return (
      <div className="container">
                  ...
                  <div className="col-md-5 school7">
                    <img src="../images/log-in.png" style={{width:'100%',height:'260px'}}/>
                  </div>
                  <div className="col-md-4 school6">
                      <form>
                          ...
                          <div class="form-group">
                            ...
                            <p><span className="school8">Forget Password!?</span></p>
                              <button type="submit" className="btn school4"><span className="school5">Submit</span></button>
                      </form>
                  </div>
                  <div className="col-md-1">
                  </div>
