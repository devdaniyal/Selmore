    	...
    	<div>
    			<div className="container">
    				<div>
          			...
          			<div className="row">
	        			<div className="col-md-2 col-5 ball3"></div>
	        			<div className="col-md-10 col-7"></div>
          			</div><br/>
          			<div>
          				<p><span className="">If your intrested in listing your ads on Selmore.com get listed today,just contact us.<br/>
          			...
          			<div>
          				<p><span className="">List your ads free<br/>
